  ...
  return (
    <>
      <div
        ...
        style={{ background: "#121212", borderRadius: "7px", padding: "23px" }}
      >
        <svg
          role="img"
          viewBox="0 0 78 24"
        ...
        <div>
          <Link to="/">
            <div className="  text-white font-bold py-5  rounded flex items-center gap-5 ">
              <div>
                <svg
                  data-encore-id="icon"
                  role="img"
        ...
        <div>
          <Link to="/search">
            <button className="text-white font-bold   rounded flex items-center gap-5">
              <svg
                data-encore-id="icon"
                role="img"
                aria-hidden="true"
      ...
      <div
        ...
        style={{ background: "#121212", borderRadius: "7px" }}
      >
        <div>
          <div
            className="Button-sc-1dqy6lx-0 khATCl px-5 py-3 flex items-center justify-between RAWO6AczuDMOTI0qAc0a OMCDc2F7g_AufJAtaKfL NxEINIJHGytq4gF1r2N1 or84FBarW2zQhXfB9VFb odS2IW9wfNVHhkhc0l_X O0AN8Ty_Cxd4iLwyKATB wQnUXn1m6Gy4PH8jhslb D8wJ9TPfJzLeLJYxnad2 oE8LAmRhbeQqsZrQo4lb zWWLnqWslTLHwq3wBgGB XNjgtSbyhshr7YQcVvry mhuhir0ikRqXAPHU8ZZ1"
          ...
          <ScrollMinibarDiv>
          <div
           className="px-2 scroll-minibar" style={ScrollerStyle}
          >
            <div
              className="p-4"
              style={{ backgroundColor: "#242424", borderRadius: "6px" }}
            >
              <h5 className="font-bold">Create your first playlist</h5>
              <p style={{ fontSize: "14px" }}>It's easy, we'll help you</p>
              <p
                className={`text-black p-2 mt-4  font-bold text-center`}
                style={{
                  fontSize: "13px",
                  background: "white",
                  width: "70%",
            ...
            <div
              ...
              style={{ backgroundColor: "#242424", borderRadius: "6px" }}
            >
              <h5 className="font-bold">Let's find some podcasts to follow</h5>
          ...
          <div className="mt-2 p-5">
            <div className="flex flex-col mb-2 ">
              <p className="" style={{ fontSize: "12px", color: "#a7a7a7" }}>
          ...
          <div>
            <div
              ...
              className="Button-sc-y0gtbx-0 fgCKqo p-1 m-4  "
              style={{
            ...
            >
              <span
                aria-hidden="true"
                className="IconWrapper__Wrapper-sc-ihacte-0 cYVsbq flex gap-2 items-center"
              >
                <svg
                  data-encore-id="icon"
                  role="img"
            ...
            <div className="m-3" style={{ border: "1px solid #121212" }}></div>
          </div>
        </div>
      </div>
    </>
